...
Comment.init = function(data) {
	...
	for (var i = 0; i < data.length; i++) {var p = new Comment(data[i].id,data[i].comment,data[i].time,data[i].task_id,data[i].user_id);
...
Component.init = function(data) {
	var newValues = new Array();
	for (var i = 0; i < data.length; i++) {var p = new Component(data[i].id,data[i].name,data[i].project_id,data[i].parent_id);
...
Sprint.init = function(data) {
	var newValues = new Array();
	for (var i = 0; i < data.length; i++) {var p = new Sprint(data[i].id,data[i].name,data[i].date,data[i].description,data[i].project_id);
		Sprints[data[i].id] = p;
		newValues[i] = p;
	}
...
Task.init = function(data) {
	var newValues = new Array();
	for (var i = 0; i < data.length; i++) {var p = new Task(data[i].project_id,data[i].id,data[i].name,data[i].description,data[i].points,data[i].user_id,data[i].department_id,data[i].component_id,data[i].sprint_id,data[i].state_id,data[i].timestamp);
		Tasks[data[i].id] = p;
		newValues[i] = p;
	}
...
Task_state.init = function(data) {
	var newValues = new Array();
	for (var i = 0; i < data.length; i++) {var p = new Task_state(data[i].id,data[i].name);
...
User.init = function(data) {
	var newValues = new Array();
	for (var i = 0; i < data.length; i++) {var p = new User(data[i].id,data[i].username,data[i].password,data[i].name,data[i].email);
		Users[data[i].id] = p;
		newValues[i] = p;
	}
