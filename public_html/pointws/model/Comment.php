<?php 
 ...
 function __construct($comment, $task_id, $user_id, $id){
	...
	public static function get($object){
		...
		return new Comment ($object->comment, $object->task_id, $object->user_id, $object->id);
	}
 ...
 // <editor-fold defaultstate="collapsed" desc="CRUD">
	 ...
	 public static function create($Comment){
		...
		return $mysql->insert(
				 " INSERT INTO `comment` (`comment`,`task_id`,`user_id`,`id`) VALUES ('$comment','$task_id','$user_id','$id')"
		);
	}
	 ...
	 public static function modify($Comment){
		$mysql = MysqlDBC::getInstance();
		 ...
		 $id = $mysql->checkVariable($Comment->getId());
		 return $mysql->update(
				"UPDATE `comment` SET`comment`='$comment',`task_id`='$task_id',`user_id`='$user_id' WHERE `id` = '$id' " 
		);
	}
